...
public:
  ...
  MemberId get_union_id() const { return eprosima::fastrtps::types::DynamicData::get_union_id(); }
};
...
std::map<std::string, ::xtypes::DynamicType::Ptr> Converter::m_types;
std::map<std::string, DynamicPubSubType*> Converter::m_registered_types;
std::map<std::string, DynamicTypeBuilder_ptr> Converter::m_builders;

// Static member initialization
//utils::Logger Converter::logger_("is::sh::FastDDS::Converter");

// This function patches the problem of dynamic types, which do not admit '/' in their type name.
std::string Converter::convert_type_name(const std::string& message_type) {
  std::string type = message_type;

  //TODO(Ricardo) Remove when old dyntypes support namespaces.
  size_t npos = type.rfind(":");
  if (std::string::npos != npos) { type = type.substr(npos + 1); }
...
const eprosima::xtypes::DynamicType&
  Converter::resolve_type(const eprosima::xtypes::DynamicType& type) {
...
void Converter::set_primitive_data(
  ::xtypes::ReadableDynamicDataRef from, DynamicData* to, MemberId id) {
  switch (resolve_type(from.type()).kind()) {
  case ::xtypes::TypeKind::BOOLEAN_TYPE:
    to->set_bool_value(from.value<bool>() ? true : false, id);
    break;
  case ::xtypes::TypeKind::CHAR_8_TYPE: to->set_char8_value(from.value<char>(), id); break;
  case ::xtypes::TypeKind::CHAR_16_TYPE:
  case ::xtypes::TypeKind::WIDE_CHAR_TYPE: to->set_char16_value(from.value<wchar_t>(), id); break;
  case ::xtypes::TypeKind::UINT_8_TYPE: to->set_uint8_value(from.value<uint8_t>(), id); break;
  case ::xtypes::TypeKind::INT_8_TYPE: to->set_int8_value(from.value<int8_t>(), id); break;
  case ::xtypes::TypeKind::INT_16_TYPE: to->set_int16_value(from.value<int16_t>(), id); break;
  case ::xtypes::TypeKind::UINT_16_TYPE: to->set_uint16_value(from.value<uint16_t>(), id); break;
  case ::xtypes::TypeKind::INT_32_TYPE: to->set_int32_value(from.value<int32_t>(), id); break;
  case ::xtypes::TypeKind::UINT_32_TYPE: to->set_uint32_value(from.value<uint32_t>(), id); break;
  case ::xtypes::TypeKind::INT_64_TYPE: to->set_int64_value(from.value<int64_t>(), id); break;
  case ::xtypes::TypeKind::UINT_64_TYPE: to->set_uint64_value(from.value<uint64_t>(), id); break;
  case ::xtypes::TypeKind::FLOAT_32_TYPE: to->set_float32_value(from.value<float>(), id); break;
  case ::xtypes::TypeKind::FLOAT_64_TYPE: to->set_float64_value(from.value<double>(), id); break;
  case ::xtypes::TypeKind::FLOAT_128_TYPE:
    to->set_float128_value(from.value<long double>(), id);
    break;
  case ::xtypes::TypeKind::STRING_TYPE: to->set_string_value(from.value<std::string>(), id); break;
  case ::xtypes::TypeKind::WSTRING_TYPE:
    to->set_wstring_value(from.value<std::wstring>(), id);
    break;
  case ::xtypes::TypeKind::ENUMERATION_TYPE: to->set_enum_value(from.value<uint32_t>(), id); break;
  default: {
...
void Converter::set_array_data(
  eprosima::xtypes::ReadableDynamicDataRef from, DynamicData* to,
...
void Converter::set_sequence_data(eprosima::xtypes::ReadableDynamicDataRef from, DynamicData* to) {
  ...
  for (uint32_t idx = 0; idx < from.size(); ++idx) {
    ...
    case ::xtypes::TypeKind::BOOLEAN_TYPE: to->set_bool_value(from[idx].value<bool>(), id); break;
    case ::xtypes::TypeKind::CHAR_8_TYPE: to->set_char8_value(from[idx].value<char>(), id); break;
    case ::xtypes::TypeKind::CHAR_16_TYPE:
    case ::xtypes::TypeKind::WIDE_CHAR_TYPE:
      to->set_char16_value(static_cast<wchar_t>(from[idx].value<char32_t>()), id);
      break;
...
void Converter::set_map_data(eprosima::xtypes::ReadableDynamicDataRef from, DynamicData* to) {
  ...
  for (::xtypes::ReadableDynamicDataRef pair : from) {
    ...
    case ::xtypes::TypeKind::BOOLEAN_TYPE: key_data->set_bool_value(key, id); break;
    case ::xtypes::TypeKind::CHAR_8_TYPE: key_data->set_char8_value(key, id); break;
    case ::xtypes::TypeKind::CHAR_16_TYPE:
    case ::xtypes::TypeKind::WIDE_CHAR_TYPE: key_data->set_char16_value(key, id); break;
    case ::xtypes::TypeKind::UINT_8_TYPE:
    ...
    case ::xtypes::TypeKind::INT_8_TYPE:
      ...
      key_data->set_byte_value(key, id);
      break;
    case ::xtypes::TypeKind::INT_16_TYPE: key_data->set_int16_value(key, id); break;
    case ::xtypes::TypeKind::UINT_16_TYPE: key_data->set_uint16_value(key, id); break;
    case ::xtypes::TypeKind::INT_32_TYPE: key_data->set_int32_value(key, id); break;
    case ::xtypes::TypeKind::UINT_32_TYPE: key_data->set_uint32_value(key, id); break;
    case ::xtypes::TypeKind::INT_64_TYPE: key_data->set_int64_value(key, id); break;
    case ::xtypes::TypeKind::UINT_64_TYPE: key_data->set_uint64_value(key, id); break;
    case ::xtypes::TypeKind::FLOAT_32_TYPE: key_data->set_float32_value(key, id); break;
    case ::xtypes::TypeKind::FLOAT_64_TYPE: key_data->set_float64_value(key, id); break;
    case ::xtypes::TypeKind::FLOAT_128_TYPE: key_data->set_float128_value(key, id); break;
    case ::xtypes::TypeKind::STRING_TYPE: key_data->set_string_value(key, id); break;
    case ::xtypes::TypeKind::WSTRING_TYPE: key_data->set_wstring_value(key, id); break;
    case ::xtypes::TypeKind::ENUMERATION_TYPE:
    ...
    case ::xtypes::TypeKind::BOOLEAN_TYPE: value_data->set_bool_value(value, id); break;
    case ::xtypes::TypeKind::CHAR_8_TYPE: value_data->set_char8_value(value, id); break;
    case ::xtypes::TypeKind::CHAR_16_TYPE:
    case ::xtypes::TypeKind::WIDE_CHAR_TYPE: value_data->set_char16_value(value, id); break;
    case ::xtypes::TypeKind::UINT_8_TYPE:
    ...
    case ::xtypes::TypeKind::INT_8_TYPE:
      ...
      value_data->set_byte_value(value, id);
      break;
    case ::xtypes::TypeKind::INT_16_TYPE: value_data->set_int16_value(value, id); break;
    case ::xtypes::TypeKind::UINT_16_TYPE: value_data->set_uint16_value(value, id); break;
    case ::xtypes::TypeKind::INT_32_TYPE: value_data->set_int32_value(value, id); break;
    case ::xtypes::TypeKind::UINT_32_TYPE: value_data->set_uint32_value(value, id); break;
    case ::xtypes::TypeKind::INT_64_TYPE: value_data->set_int64_value(value, id); break;
    case ::xtypes::TypeKind::UINT_64_TYPE: value_data->set_uint64_value(value, id); break;
    case ::xtypes::TypeKind::FLOAT_32_TYPE: value_data->set_float32_value(value, id); break;
    case ::xtypes::TypeKind::FLOAT_64_TYPE: value_data->set_float64_value(value, id); break;
    case ::xtypes::TypeKind::FLOAT_128_TYPE: value_data->set_float128_value(value, id); break;
    case ::xtypes::TypeKind::STRING_TYPE: value_data->set_string_value(value, id); break;
    case ::xtypes::TypeKind::WSTRING_TYPE: value_data->set_wstring_value(value, id); break;
    case ::xtypes::TypeKind::ENUMERATION_TYPE:
...
bool Converter::xtypes_to_fastdds(const ::xtypes::DynamicData& input, DynamicData* output) {
...
bool Converter::set_struct_data(
  eprosima::xtypes::ReadableDynamicDataRef input, DynamicData* output) {
  std::stringstream ss;
...
void Converter::set_sequence_data(
  const DynamicData* c_from, eprosima::xtypes::WritableDynamicDataRef to) {
...
void Converter::set_map_data(
  const DynamicData* c_from, eprosima::xtypes::WritableDynamicDataRef to) {
  const ::xtypes::MapType& map_type = static_cast<const ::xtypes::MapType&>(to.type());
  const ::xtypes::PairType& pair_type =
    static_cast<const ::xtypes::PairType&>(map_type.content_type());
...
bool Converter::fastdds_to_xtypes(const DynamicData* c_input, ::xtypes::DynamicData& output) {
...
eprosima::fastrtps::types::TypeKind
  Converter::resolve_type(const eprosima::fastrtps::types::DynamicType_ptr type) {
...
bool Converter::set_struct_data(
  const DynamicData* c_input, eprosima::xtypes::WritableDynamicDataRef output) {
  std::stringstream ss;
  uint32_t id = 0;
  uint32_t i = 0;
...
eprosima::xtypes::DynamicData Converter::dynamic_data(const std::string& type_name) {
...
DynamicTypeBuilder* Converter::create_builder(const eprosima::xtypes::DynamicType& type) {
  if (m_builders.count(type.name()) > 0) {
    return static_cast<DynamicTypeBuilder*>(m_builders[type.name()].get());
  }
  ...
  m_builders.emplace(type.name(), std::move(builder));
  return result;
}

DynamicTypeBuilder_ptr Converter::get_builder(const eprosima::xtypes::DynamicType& type) {
  ...
  case ::xtypes::TypeKind::ENUMERATION_TYPE: {
    ...
    for (auto pair : enumerators) { builder->add_empty_member(pair.second, pair.first); }
    return builder;
  }
  ...
  case ::xtypes::TypeKind::MAP_TYPE: {
    ...
    const ::xtypes::PairType& content_type =
      static_cast<const ::xtypes::PairType&>(c_type.content_type());
    DynamicTypeBuilder_ptr key = get_builder(content_type.first());
    DynamicTypeBuilder_ptr value = get_builder(content_type.second());
    DynamicTypeBuilder_ptr result =
      factory->create_map_builder(key.get(), value.get(), c_type.bounds());
    return result;
  }
  case ::xtypes::TypeKind::UNION_TYPE: {
    ...
    for (const std::string& member_name : c_type.get_case_members()) {
      ...
      for (int64_t label : labels_original) { labels.push_back(static_cast<uint64_t>(label)); }
...
void Converter::get_array_specs(
...
const xtypes::DynamicType& Converter::resolve_discriminator_type(
  const eprosima::xtypes::DynamicType& service_type, const std::string& discriminator) {
  if (discriminator.find(".") == std::string::npos) { return service_type; }
  ...
  while (path.find(".") != std::string::npos) {
    ...
    if (type_ptr->is_aggregation_type()) {
      const xtypes::AggregationType& aggregation =
        static_cast<const xtypes::AggregationType&>(*type_ptr);
...
eprosima::xtypes::WritableDynamicDataRef Converter::access_member_data(
  ...
  // Split the path
  while (std::getline(iss, token, '.')) { nodes.push_back(token); }
