...
namespace ddsfmu {
  ...
  struct Converter
  {
    ...
    */
    static bool xtypes_to_fastdds(
        ...
        eprosima::fastrtps::types::DynamicData* output);
    ...
    */
    static bool fastdds_to_xtypes(
        ...
        eprosima::xtypes::DynamicData& output);
    ...
    */
    static eprosima::xtypes::DynamicData dynamic_data(
    ...
    */
    static void register_type(
        const std::string& type_name,
        eprosima::fastrtps::types::DynamicPubSubType* type){
    ...
    */
    static eprosima::fastrtps::types::DynamicTypeBuilder* create_builder(
  ...
  private:
    ...
    static const eprosima::xtypes::DynamicType& resolve_type(const eprosima::xtypes::DynamicType& type);
    static eprosima::fastrtps::types::TypeKind resolve_type(const eprosima::fastrtps::types::DynamicType_ptr type);
    static eprosima::fastrtps::types::DynamicTypeBuilder_ptr get_builder(const eprosima::xtypes::DynamicType& type);

    static void get_array_specs(
        const eprosima::xtypes::ArrayType& array,
        std::pair<std::vector<uint32_t>,
        eprosima::fastrtps::types::DynamicTypeBuilder_ptr>& result);
    ...
    static void set_primitive_data(
        ...
        eprosima::fastrtps::types::DynamicData* to,
