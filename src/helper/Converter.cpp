...
public:
  ...
  {
    return eprosima::fastrtps::types::DynamicData::get_union_id();
  }
...
std::string Converter::convert_type_name(
...
const eprosima::xtypes::DynamicType& Converter::resolve_type(
...
void Converter::set_array_data(
        eprosima::xtypes::ReadableDynamicDataRef from,
        DynamicData* to,
...
bool Converter::xtypes_to_fastdds(
...
bool Converter::set_struct_data(
        eprosima::xtypes::ReadableDynamicDataRef input,
        DynamicData* output)
{
    std::stringstream ss;
...
bool Converter::fastdds_to_xtypes(
...
eprosima::fastrtps::types::TypeKind Converter::resolve_type(
...
eprosima::xtypes::DynamicData Converter::dynamic_data(
...
DynamicTypeBuilder* Converter::create_builder(
        const eprosima::xtypes::DynamicType& type)
{
...
DynamicTypeBuilder_ptr Converter::get_builder(
        const eprosima::xtypes::DynamicType& type)
{
...
eprosima::xtypes::WritableDynamicDataRef Converter::access_member_data(
    eprosima::xtypes::WritableDynamicDataRef membered_data,
