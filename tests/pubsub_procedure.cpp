...
public:
  ...
  MyReaderListener(
    eprosima::fastrtps::types::DynamicData* dynamic_data, eprosima::xtypes::DynamicData& message)
...
TEST(PubSub, UsageProcedure) {
  ...
  eprosima::fastrtps::types::DynamicTypeBuilder* builder =
    ddsfmu::Converter::create_builder(message_type);
  ...
  eprosima::fastdds::dds::DataWriter* datawriter =
    publisher->create_datawriter(topic, eprosima::fastdds::dds::DATAWRITER_QOS_DEFAULT);
